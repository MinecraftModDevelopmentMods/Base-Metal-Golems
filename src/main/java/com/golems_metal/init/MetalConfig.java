...
public class MetalConfig {
	...
	public static void mainRegistry(Configuration config) {
		...
		GolemLookup.addConfig(EntityChromiumGolem.class,
				new GolemConfigSet(config, "Chromium Golem", 36.0D, 6.3F));
		...
		GolemLookup.addConfig(EntityOsmiumGolem.class,
				new GolemConfigSet(config, "Osmium Golem", 32.0D, 4.8F));
		GolemLookup.addConfig(EntityPlutoniumGolem.class,
				...
				.addKey(EntityPlutoniumGolem.AOE, 1.5F, 0.1F, 8.0F, "Poison effect radius")
				.addKey(EntityPlutoniumGolem.DURATION, 36, 1, 1000, "Poison effect length (in ticks)")
		...
		GolemLookup.addConfig(EntityUraniumGolem.class,
				...
				.addKey(EntityPlutoniumGolem.ALLOW_POISON, true, "Whether this golem can poison nearby creatures")
				.addKey(EntityPlutoniumGolem.AOE, 2.1F, 0.1F, 8.0F, "Poison effect radius")
				.addKey(EntityPlutoniumGolem.DURATION, 18, 1, 1000, "Poison effect length (in ticks)")
